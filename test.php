...
<?php
  $connection = new PDO("mysql:dbname=roydonf_roydon");
              ...
              <tbody>
                <?php
                  ...
                  foreach ($shows as $show) {
                    echo "<tr id='$show[aika]'><td headers='show_time'>".date_conv($show['aika'], $show['kesto'])."</td>\n";
                    echo "<td headers='show_name'><a href='$show[link]'>$show[nimi]</a></td>\n";
                    echo "<td headers='show_place'>$show[paikka]</td>";
                    echo "\n</tr>\n";
                  }
                ?>
              </tbody>
